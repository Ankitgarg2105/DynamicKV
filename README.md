...
```bash
git clone https://github.com/Ankitgarg2105/DynamicKV.git
cd DynamicKV
make
````
...
Alternatively, download a **prebuilt binary** from the [Releases](https://github.com/Ankitgarg2105/DynamicKV/releases) page and unpack it.
